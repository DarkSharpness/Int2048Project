...
int2048 &operator -= (int2048 &lhs, int2048_view rhs) { return lhs += rhs.reverse(); }
int2048 &operator -= (int2048 &lhs, int2048 &&rhs) { return lhs += std::move(rhs.reverse()); }

int2048 operator - (int2048_view lhs, int2048_view rhs) { return lhs + rhs.reverse(); }
int2048 operator - (int2048_view lhs, int2048 &&rhs) { return std::move(rhs.reverse() += lhs); }
int2048 operator - (int2048 &&lhs, int2048_view rhs) { return std::move(lhs += rhs.reverse());  }
int2048 operator - (int2048 &&lhs, int2048 &&rhs) { return std::move(lhs += std::move(rhs.reverse())); }
